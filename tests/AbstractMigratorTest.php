...
use Dream_Encode\WordPress_Plugin_Utils\Tests\Fixtures\Test_Migrator;
use WP_UnitTestCase;

/**
 * Test case for Abstract_Migrator.
 */
class AbstractMigratorTest extends WP_UnitTestCase {
	...
	public function test_default_state(): void {
		...
		$this->assertSame( Abstract_Migrator::MIGRATION_STATUS_QUEUED, $migrator->get_status() );
	}
	...
	public function test_get_migrator_returns_slug(): void {
		...
		$this->assertSame( 'test_migrator', $migrator->get_migrator() );
	}
	...
	public function test_get_label_returns_default_label(): void {
		...
		$this->assertSame( 'Abstract Migrator', $migrator->get_label() );
	}
	...
	public function test_get_progress_exposes_state(): void {
		...
		$this->assertSame( 'test_migrator', $progress['migrator'] );
